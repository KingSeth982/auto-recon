...
sys.path.insert(0,config.get('paths','recon_path'))
...
def run_recon(domains):
	...
	config['theHarvester']['always_run'].getboolean():
...
def sync_keys(reconBase=''):
	...
	print(not imput and options.getboolean('key_auto_update'))
...
parser.add_argument("-l", '--linkedin', action='append', dest='companies', help="name of the company to be searched on linkedin")
